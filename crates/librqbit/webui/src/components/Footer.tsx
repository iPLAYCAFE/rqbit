...
export const Footer: React.FC<{}> = () => {
  ...
  return (
    <div className="sticky bottom-0 bg-surface-raised text-nowrap text-sm font-medium text-secondary flex gap-x-1 lg:gap-x-5 justify-evenly flex-nowrap overflow-hidden border-t border-divider">
      <FooterPiece>
