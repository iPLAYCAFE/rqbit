      ...
      content: (
        <Fieldset>
          ...
          <FormCheck
            ...
            name="features.enable_file_logging"
            checked={!!config.features?.enable_file_logging}
            onChange={handleToggleChange}
            help="If enabled, writes detailed application and connection logs to rqbit.log for troubleshooting (takes effect on restart)."
          />
        </Fieldset>
      ),
    },
